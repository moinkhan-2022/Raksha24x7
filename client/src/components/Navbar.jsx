        ...
        {dashboard && (
          <div className="relative flex items-center gap-2">
            ...
            {open && <div className="absolute right-0 top-12 w-52 rounded-xl border border-white/10 bg-slate-900 p-2 text-sm">
              ...
              <button onClick={logout} className="mt-1 flex w-full items-center gap-2 rounded px-3 py-2 text-left hover:bg-red-500/20"><LogOut className="h-4 w-4" />Logout</button>
            </div>}
          </div>
        )}
      </div>
